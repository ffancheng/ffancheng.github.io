...
<!-- See here for <a href=`r fs::path_ext_set(current_file, 'pdf')`>PDF <i class="fas fa-file-pdf"></i></a>. -->
</div>
...
<br><br>
## <span style="color: #ccf2ff; text-shadow: 10px 10px 100px white;">`r rmarkdown::metadata$subtitle`</span>
...
`r anicon::faa("twitter", animate="float", speed="fast")`  @fanchengfc
