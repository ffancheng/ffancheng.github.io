...
```{r Kins, fig.align = 'center', out.width = "100%", echo = FALSE, fig.cap="Intrusions and extrusions of co-Ranking matrix."}
...
```{r optimal_eps, message=FALSE, cache=TRUE, echo=TRUE}
K <- qualities$K[1]
eps_seq <- seq(0, 2, 0.1)
...
```{r plot_optim, message=FALSE, echo=TRUE}
...
```{r manifolds, fig.align='center', out.width="80%", echo=FALSE}
