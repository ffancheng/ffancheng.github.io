...
eg. can be achieved by simply setting an upper bound on the number of points to examine the tree, or by interrupting the search process bsed upon a real time clock
