...
- But what about **8 million** household in VIC? Computation efficiency matters
...
```{r annembedding, fig.align = 'center', out.width = "100%", fig.cap="2-d embeddings from four manifold learning methods, with the color representing half-hourly time of day. ", echo = FALSE, message=FALSE}
